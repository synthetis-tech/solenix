...
func (x *DropMetricRequest) Reset() {
	*x = DropMetricRequest{}
...
func (x *DropMetricRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DropMetricRequest) ProtoMessage() {}

func (x *DropMetricRequest) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_solenix_proto_msgTypes[11]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DropMetricRequest.ProtoReflect.Descriptor instead.
func (*DropMetricRequest) Descriptor() ([]byte, []int) {
	return file_api_proto_solenix_proto_rawDescGZIP(), []int{11}
}

func (x *DropMetricRequest) GetMetric() string {
	if x != nil {
		return x.Metric
	}
	return ""
...
type DropMetricResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Dropped       bool                   `protobuf:"varint,1,opt,name=dropped,proto3" json:"dropped,omitempty"` // false если метрика не существовала
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DropMetricResponse) Reset() {
	*x = DropMetricResponse{}
	mi := &file_api_proto_solenix_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DropMetricResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DropMetricResponse) ProtoMessage() {}

func (x *DropMetricResponse) ProtoReflect() protoreflect.Message {
	mi := &file_api_proto_solenix_proto_msgTypes[12]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DropMetricResponse.ProtoReflect.Descriptor instead.
func (*DropMetricResponse) Descriptor() ([]byte, []int) {
	return file_api_proto_solenix_proto_rawDescGZIP(), []int{12}
}

func (x *DropMetricResponse) GetDropped() bool {
	if x != nil {
		return x.Dropped
	}
	return false
...
const file_api_proto_solenix_proto_rawDesc = "" +
	...
	"\aMetrics\x12\x17.solenix.MetricsRequest\x1a\x18.solenix.MetricsResponse\x12E\n" +
	"\n" +
	"DropMetric\x12\x1a.solenix.DropMetricRequest\x1a\x1b.solenix.DropMetricResponseB7Z5github.com/synthetis-tech/solenix/api/proto;solenixpbb\x06proto3"
...
var file_api_proto_solenix_proto_goTypes = []any{
	...
	(*DropMetricRequest)(nil),  // 11: solenix.DropMetricRequest
	(*DropMetricResponse)(nil), // 12: solenix.DropMetricResponse
